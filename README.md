# Consignes Permanentes Castorama Claye-Souilly

Application web React/Vite prête à déposer sur GitHub et à publier sur Vercel ou Netlify. Les identifiants de démonstration ne sont plus affichés sur la page de connexion.
